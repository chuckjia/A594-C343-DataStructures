...
public class Driver {
	public static void main(String[] args) {
		...
		String text = Util.loadFile("the-thirty-nine-steps.txt");
		...
		System.out.println("The savings percentage is " + 
				(float) (text.length() * Constants.BITESIZE - bits.length())/(text.length() * Constants.BITESIZE)*100 + "%.");
